  ...
  return (
    <>
      <PageHeading
        title={t.blog.title}
        action={
          <Link href="/dashboard/blog/new" className="btn-gradient h-[52px] px-7 rounded-xl text-base">
            {t.blog.new}
          </Link>
        }
      />
      ...
      <Card className="overflow-hidden">
        {docs.length === 0 ? (
          <p className="p-10 font-poppins text-brand-dark/60">{t.blog.empty}</p>
        ) : (
            ...
            <table className="w-full min-w-[720px]">
              <thead>
                <tr className="border-b border-brand-gray/50 text-left">
                  ...
                  <th className="px-4 py-4 font-poppins font-bold text-sm text-[#002B58]">{t.table.date}</th>
