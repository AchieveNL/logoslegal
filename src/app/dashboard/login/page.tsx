...
export default function DashboardLoginPage() {
  ...
  const fieldClass =
    "w-full h-[64px] border border-[#292D32] rounded-lg px-5 font-poppins text-base text-brand-dark focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 focus:outline-none transition-[border-color,box-shadow]";
  const labelClass =
      ...
      <div className="relative w-full max-w-[520px] bg-white rounded-[24px] shadow-[0_10px_40px_-12px_rgba(2,18,43,0.18)] ring-1 ring-brand-dark/5 p-10 md:p-12">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
          ...
          <button
            type="submit"
            disabled={busy}
            className="btn-gradient w-full h-[64px] rounded-lg text-lg"
          >
