...
export async function generateMetadata(
  ...
  const t = await getTranslations({
    locale,
    namespace: "practice.contracten.meta",
  });
  return {
    title: t("title"),
...
export default async function ContractenPage(
  ...
  const t = await getTranslations("practice.contracten");
  ...
  return (
    <>
      ...
      <HeroBanner title={tAreas("contracten")} subtitle={t("hero.subtitle")} />
