...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "practice.mensenrechten.meta",
  });
  return {
    title: t("title"),
...
export default async function MensenrechtenPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  unstable_setRequestLocale(locale);
  const t = await getTranslations("practice.mensenrechten");
  ...
  return (
    <>
      ...
      <BenefitsSection
        heading={t.rich("benefits.heading", {
          blue,
