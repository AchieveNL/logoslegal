...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "advocates.anilRamdas",
  });
  return {
    title: t("meta.title"),
...
export default async function AnilRamdasPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  unstable_setRequestLocale(locale);
  const t = await getTranslations("advocates.anilRamdas");
  ...
  return (
    <>
      ...
      <HeroBanner title="Anil Ramdas" subtitle={t("hero.subtitle")} />
