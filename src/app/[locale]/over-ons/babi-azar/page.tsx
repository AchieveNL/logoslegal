...
export default async function BabiAzarPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  unstable_setRequestLocale(locale);
  const t = await getTranslations("advocates.babiAzar");
  ...
  return (
    <>
      ...
      <HeroBanner title="Babi Azar" subtitle={t("hero.subtitle")} />
